...
curl -fsSL -o "$router_dir/china_ip_list.txt"       "https://raw.githubusercontent.com/17mon/china_ip_list/master/china_ip_list.txt" || { echo "Failed to download china_ip_list.txt"; exit 1; }
