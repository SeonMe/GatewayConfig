...
add address=fd00::/64 comment="lanconf: local LAN IPv6 ULA subnet" list=local_subnet_ipv6
add address=fd00::2 comment="lanconf: local DNSv6 server" list=local_dns_ipv6
add address=fd00::4 comment="lanconf: local DNSv6 server" list=local_dns_ipv6
...
add action=masquerade chain=srcnat comment="lanconf: masquerade IPv6 ULA" out-interface-list=WAN src-address-list=local_subnet_ipv6

/ipv6 firewall nat
add action=masquerade chain=srcnat comment="lanconf: ZeroTier masquerade" out-interface=Bridge
